...
function Header() {
  ...
  return (
    <div className={`d-none d-lg-block row gy-1 dashboard-header p-1 py-2 py-lg-0 my-2 ${context.nightMode ? 'bg-dark' : 'bg-primary'}`}>
      <div className="col row align-items-center justify-content-between m-0">
        ...
        <div className='w-auto row align-items-center'>
          ...
          <button className={`btn d-lg-none col-auto ${context.nightMode ? 'btn-dark' : 'btn-primary'}`} type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasResponsive" aria-controls="offcanvasResponsive">

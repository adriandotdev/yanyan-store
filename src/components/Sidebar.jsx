...
function Sidebar() {
  ...
  const { nightMode, setNightMode, logout, role, ICON_DARK_COLOR, ICON_LIGHT_COLOR } = useContext(UtilityContext);
  ...
  return (
    <div className={`d-none d-lg-block col-3 col-xxl-2 rounded border px-0  ${nightMode ? 'bg-dark border-accent border-opacity-10' : 'border-primary border-opacity-10'}`}>
      <h1 className={`h2 fw-bold store-title my-4 mx-2 px-3 ${nightMode ? 'text-accent' : 'text-dark-secondary'}`}>Dashboard</h1>

      <div>
        {/* Add Product */}
        <NavLink to='add-product' className={`text-decoration-none ${nightMode ? 'dashboard-item-dark' : 'dashboard-item'}`}>

          <div className={`py-3 m-0  row align-items-center item ${nightMode ? 'text-accent' : 'text-dark-secondary'}`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill={`${nightMode ? ICON_DARK_COLOR : ICON_LIGHT_COLOR}`} className="bi bi-plus col-3" viewBox="0 0 16 16">
        ...
        {
          role?.toLowerCase() === 'store owner' &&
          <NavLink NavLink to='add-user' className={`text-decoration-none ${nightMode ? 'dashboard-item-dark' : 'dashboard-item'}`}>

            <div className={`py-3 m-0  row align-items-center item ${nightMode ? 'text-accent' : 'text-dark-secondary'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill={`${nightMode ? ICON_DARK_COLOR : ICON_LIGHT_COLOR}`} className="bi bi-person-add col-3" viewBox="0 0 16 16">
        ...
        {/* Products */}
        <NavLink to='products' className={`text-decoration-none ${nightMode ? 'dashboard-item-dark' : 'dashboard-item'}`}>
          ...
          <div className={`py-3 m-0  row align-items-center item ${nightMode ? 'text-accent' : 'text-dark-secondary'}`}>
            ...
            <div className='col-auto fw-bold h5 m-0 p-0'>Products</div>
          </div>
        </NavLink>
        ...
        {/* Users */}
        {
          ...
          <NavLink to='users' className={`text-decoration-none ${nightMode ? 'dashboard-item-dark' : 'dashboard-item'}`}>
            ...
            <div className={`py-3 m-0  row align-items-center item ${nightMode ? 'text-accent' : 'text-dark-secondary'}`}>
              <svg width="32" height="32" viewBox="0 0 24 24" fill={`${nightMode ? ICON_DARK_COLOR : ICON_LIGHT_COLOR}`} className="bi bi-person-add col-3" xmlns="http://www.w3.org/2000/svg">
        ...
        <div onClick={() => {
        ...
        }} className={`btn-dark-mode py-3 px-2 m-0 row align-items-center item ${nightMode ? 'text-accent' : 'text-dark-secondary'}`}>
          {
            nightMode ? <svg className="col-3" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="32" viewBox="0 0 24 24" width="32" fill="#EDF2FA"><rect fill="none" height="24" width="24" /><path d="M12,3c-4.97,0-9,4.03-9,9s4.03,9,9,9s9-4.03,9-9c0-0.46-0.04-0.92-0.1-1.36c-0.98,1.37-2.58,2.26-4.4,2.26 c-2.98,0-5.4-2.42-5.4-5.4c0-1.81,0.89-3.42,2.26-4.4C12.92,3.04,12.46,3,12,3L12,3z" /></svg>
              ...
              <svg className='col-3' xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="32" viewBox="0 0 24 24" width="32" fill="#2A5394"><rect fill="none" height="24" width="24" /><path d="M12,7c-2.76,0-5,2.24-5,5s2.24,5,5,5s5-2.24,5-5S14.76,7,12,7L12,7z M2,13l2,0c0.55,0,1-0.45,1-1s-0.45-1-1-1l-2,0 c-0.55,0-1,0.45-1,1S1.45,13,2,13z M20,13l2,0c0.55,0,1-0.45,1-1s-0.45-1-1-1l-2,0c-0.55,0-1,0.45-1,1S19.45,13,20,13z M11,2v2 c0,0.55,0.45,1,1,1s1-0.45,1-1V2c0-0.55-0.45-1-1-1S11,1.45,11,2z M11,20v2c0,0.55,0.45,1,1,1s1-0.45,1-1v-2c0-0.55-0.45-1-1-1 C11.45,19,11,19.45,11,20z M5.99,4.58c-0.39-0.39-1.03-0.39-1.41,0c-0.39,0.39-0.39,1.03,0,1.41l1.06,1.06 c0.39,0.39,1.03,0.39,1.41,0s0.39-1.03,0-1.41L5.99,4.58z M18.36,16.95c-0.39-0.39-1.03-0.39-1.41,0c-0.39,0.39-0.39,1.03,0,1.41 l1.06,1.06c0.39,0.39,1.03,0.39,1.41,0c0.39-0.39,0.39-1.03,0-1.41L18.36,16.95z M19.42,5.99c0.39-0.39,0.39-1.03,0-1.41 c-0.39-0.39-1.03-0.39-1.41,0l-1.06,1.06c-0.39,0.39-0.39,1.03,0,1.41s1.03,0.39,1.41,0L19.42,5.99z M7.05,18.36 c0.39-0.39,0.39-1.03,0-1.41c-0.39-0.39-1.03-0.39-1.41,0l-1.06,1.06c-0.39,0.39-0.39,1.03,0,1.41s1.03,0.39,1.41,0L7.05,18.36z" /></svg>
          }
